...
class gsp_contact_contactshow_gsp extends GroovyPage {
...
invokeTag('link','g',9,['action':("edit"),'id':(contact.id)],2)
printHtmlPart(6)
createClosureForHtmlPart(8, 2)
invokeTag('link','g',10,['action':("delete"),'id':(contact.id)],2)
printHtmlPart(3)
})
...
public static final long LAST_MODIFIED = 1514692468592L
